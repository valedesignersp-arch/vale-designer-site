  ...
  useEffect(() => {
    ;(async () => {
      const res = await fetch(
        "/api/list-media?folder=" + encodeURIComponent("portfolio/luminosos"),
        { cache: "no-store" }
      )
  ...
  return (
    <main style={{ background: "#eef2f7", minHeight: "100vh" }}>
      ...
      <div className="wrap">
        ...
        <div className="title">Luminosos</div>
        ...
        {midias.length === 0 ? (
          <div className="empty">
            Nenhuma mídia encontrada em <b>public/portfolio/luminosos/</b>
          </div>
        ) : (
          <div className="grid">
            {midias.map((m) => (
              ...
              >
                <div className="thumb">
                  {m.type === "image" ? (
                    <img src={m.src} alt={m.label || "Luminosos"} loading="lazy" />
                  ) : (
                    <>
