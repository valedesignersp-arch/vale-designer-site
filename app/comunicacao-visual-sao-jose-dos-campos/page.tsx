...
// ✅ Use SOMENTE clientes reais (ajuste se precisar)
const CLIENT_LOGOS = [
...
const FAQ = [
  {
    q: "Vocês atendem toda São José dos Campos?",
    a: "Sim. Atendemos todas as regiões de São José dos Campos e também cidades próximas no Vale do Paraíba.",
  },
  {
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/comunicacao-visual-sao-jose-dos-campos" },
  openGraph: {
    type: "website",
    url: `${DOMAIN}/comunicacao-visual-sao-jose-dos-campos`,
    siteName: SITE_NAME,
    locale: "pt_BR",
...
function JsonLd() {
  const jsonLd = {
    ...
    serviceType: ["Fachada em ACM", "Letras Caixa", "Luminosos", "Adesivagem", "Placas e Sinalização", "Impressão Digital"],
    areaServed: [
      { "@type": "City", name: CITY },
    ...
    <main>
      ...
      <style>{`
        ...
        .heroGrid{
          ...
          gap: 18px;
          align-items: start; /* ✅ NÃO ESTICA o card branco */
        }
        .kicker{
          display:inline-flex;
          gap:10px;
        ...
        /* ✅ PROVA SOCIAL (BRANCO, SEM ESTICAR, SEM “BRANCÃO”) */
        .trustCard{
          background:#ffffff;
      ...
      <section className="heroLP">
        <div className="wrap heroGrid">
          <div>
            ...
            <p className="sub">
              Projetos profissionais para empresas — do conceito à instalação.
              Atendimento em <b>{CITY}</b> e região, com padrão premium e acabamento impecável.
            </p>
